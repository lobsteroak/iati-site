            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    <div className="w-10 h-10 bg-neutral-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-neutral-200 transition-colors">
                      <svg
                        className="w-5 h-5 text-foreground"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                    ...
                    <span className="font-semibold group-hover:text-muted transition-colors">LinkedIn</span>
                  </a>
                </div>
              </div>
