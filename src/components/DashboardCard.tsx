...
export function DashboardCard() {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-3xl bg-gradient-to-b from-gray-100 to-gray-200 p-[1px] shadow-2xl shadow-gray-300/50">
        {/* Main card */}
        <div className="rounded-3xl bg-gradient-to-b from-gray-900 to-gray-950 p-6 lg:p-8 overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between mb-8">
            <span className="px-4 py-2 rounded-full bg-gray-800 text-white text-sm font-medium">
              Redução de custos
            </span>
          ...
          <div className="relative h-48 mb-6">
            ...
            <motion.div
              ...
              className="absolute top-4 left-1/3 text-white text-2xl lg:text-3xl font-bold"
            >
            ...
            >
              ...
              >
                <circle cx="200" cy="70" r="12" fill="rgba(255,255,255,0.1)" />
                <circle cx="200" cy="70" r="8" fill="white" />
                <circle cx="200" cy="70" r="4" fill="gray" />
              </motion.g>
            </svg>
          </div>
